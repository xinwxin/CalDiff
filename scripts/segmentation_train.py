...
from guided_diffusion.msloader import MSDataset
...
def main():
    ...
    if args.data_dir.endswith('/data/training'):
        ds = LIDCDataset(args.data_dir, test_flag=False)
    if args.data_dir == './data_ms/training' or args.data_dir == './data_ms0/training':
        ds = MSDataset(args.data_dir, test_flag=False)
